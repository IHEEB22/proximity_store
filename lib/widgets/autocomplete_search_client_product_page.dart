        ...
        children: [
          Container(
            child: TypeAheadFormField<ClientProduct>(
              suggestionsBoxVerticalOffset: context.read<ClientProvider>().hideSuggestion ? 0.8.sh : 0.15.sh,
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        color: Color.fromARGB(28, 255, 0, 119),
                                      ),
                                      child: Center(
                                        child: Padding(
                                          padding: EdgeInsets.symmetric(horizontal: 0.012.sw, vertical: 0.0049.sh),
                                          child: Text(
                                            suggestion.storeFarDestination.toString(),
                                            style: Theme.of(context).textTheme.bodyText1?.copyWith(
                                                  fontFamily: 'Montserrat',
                                                  fontSize: 10.sp,
              ...
              suggestionsCallback: context.read<ClientProvider>().getProductSuggestion,
